...
// Factory pattern
// Classical factory for creating dom elements.
// Abstract in current case, for purposes of implementing Prototype pattern

var DomElementsFactory = function () {
    function DomElementsFactory() {
        _classCallCheck(this, DomElementsFactory);

        this.tag = '';
    }

    _createClass(DomElementsFactory, [{
        key: 'create',
        value: function create(optionsObject) {
            var element = document.createElement(this.tag);
            if (optionsObject) {
                var attributes = Object.keys(optionsObject);
                attributes.forEach(function (attr) {
                    return element.setAttribute(attr, optionsObject[attr]);
                });
            }
            return element;
        }
    ...
    return DomElementsFactory;
}();

// Prototype pattern
// Implementation of prototype creational pattern


var factoryPrototype = new DomElementsFactory();

var divFactory = exports.divFactory = Object.create(factoryPrototype);
divFactory.tag = 'div';

var optionFactory = exports.optionFactory = Object.create(factoryPrototype);
optionFactory.tag = 'option';

var articleFactory = exports.articleFactory = Object.create(factoryPrototype);
articleFactory.tag = 'article';

var buttonFactory = exports.buttonFactory = Object.create(factoryPrototype);
buttonFactory.tag = 'button';

// Decorator pattern
// Just in educational purposes, decorates factory, adding in logging functionality...

var FactoryDecorator = function (_DomElementsFactory) {
    _inherits(FactoryDecorator, _DomElementsFactory);

    function FactoryDecorator(domElementsFactory) {
        _classCallCheck(this, FactoryDecorator);

        var _this = _possibleConstructorReturn(this, (FactoryDecorator.__proto__ || Object.getPrototypeOf(FactoryDecorator)).call(this));

        _this.domElementsFactory = domElementsFactory;
        return _this;
    }

    _createClass(FactoryDecorator, [{
        key: 'create',
        value: function create(optionsObject) {
...
var LoggerDecorator = exports.LoggerDecorator = function (_FactoryDecorator) {
    _inherits(LoggerDecorator, _FactoryDecorator);

    function LoggerDecorator(domElementsFactory) {
        _classCallCheck(this, LoggerDecorator);

        return _possibleConstructorReturn(this, (LoggerDecorator.__proto__ || Object.getPrototypeOf(LoggerDecorator)).call(this, domElementsFactory));
    }

    _createClass(LoggerDecorator, [{
        key: 'create',
        value: function create(optionsObject) {
            console.info('Element created!');
            return _get(LoggerDecorator.prototype.__proto__ || Object.getPrototypeOf(LoggerDecorator.prototype), 'create', this).call(this, optionsObject);
        }
    }]);
...
var getRandomIntNumber = exports.getRandomIntNumber = function getRandomIntNumber(min, max) {
    return Math.floor(Math.random() * (max - min + 1)) + min;
};

var isValid = exports.isValid = function isValid(variable) {
    return variable !== undefined && variable !== null && variable !== '';
};

// Proxy and Strategy
// This Proxy class checks if requested page articles were downloaded before.
// If a page was seen by user, it is returned from pagesCache, which increases app
// efficiency, reduces net load and reduces network dependency.

// This proxy class uses the supplied fetching strategy to download new articles.
// If something changes in the external api, we won't need to change proxy implementation,
// we'll just create a new proxy with another strategy.

var PageGetterProxy = exports.PageGetterProxy = function () {
    function PageGetterProxy(fetchStrategy) {
        _classCallCheck(this, PageGetterProxy);

        this.pagesCache = {};
        this.fetchPage = fetchStrategy;
    }

    _createClass(PageGetterProxy, [{
        key: 'getPage',
        value: function getPage(pageNumber) {
            if (isValid(this.pagesCache[pageNumber])) {
                return this.pagesCache[pageNumber];
            }
            this.pagesCache[pageNumber] = this.fetchPage(pageNumber);
            return this.pagesCache[pageNumber];
        }
    }, {
        key: 'clearPages',
...
var json = _interopRequireWildcard(_test);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var landing = document.querySelector('.landing');

var startButton = _utils.buttonFactory.create({ class: 'btn-start' });
startButton.innerHTML = 'START APPLICATION';
startButton.onclick = function () {
    __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 332)).then(function (module) {
        var startup = module.default;
        startup();
    });
};
...
module.exports = __webpack_require__.p + "json/test.js";
